...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXSuperApp",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperApp-1.0.0-beta+20230610052334.xcframework.zip",
			checksum: "3654fa4ce21073df619d28aa5bc0d8dbdf2e9fdef979c1da9ceb4c3f7bcec0fe"
		)
	]
)