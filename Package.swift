...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXSuperApp",
			url: "https://pkgs.genexus.dev/iOS/releases/GXSuperApp-1.1.0-rc.1.xcframework.zip",
			checksum: "089a17dd4cb807ec1a49a3228167823507f244d27fc9578ea44c21d5b4c95a95"
		)
	]
)